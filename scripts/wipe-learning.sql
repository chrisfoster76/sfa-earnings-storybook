-- Wipe script for SFA.DAS.Learning.Database
...
DELETE FROM ShortCourseMilestone;
DELETE FROM ShortCourseEpisode;
DELETE FROM ShortCourseLearningSupport;
DELETE FROM ShortCourseLearning;
DELETE FROM Learner;
